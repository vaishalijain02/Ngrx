...
export const loadedSummary = createAction(
  '[API call] Loaded Summary Data Success',
  props<{ summary: Summary }>()
);

export const loadedSummaryFailed = createAction(
  '[API call] Loaded Summary Data fail'
);
